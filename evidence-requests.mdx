...
When an evidence request is created and assigned to an auditee they are notified and provided a link to access a Recap IA portal and upload the evidence. This allows auditors to easily track outstanding evidence requests and send automated evidence as due-dates approach or are exceeded.    
