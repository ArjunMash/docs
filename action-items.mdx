...
flowchart LR
  ...
  subgraph AUD["Audit team"]
    CA[["Assign recommendation and send request"]]
    PR{"Review plan"}
...
| Status | Description |
| --- | --- |
| Plan Requested | After the action item has been created and the auditor is awaiting management's plan. |
...
| Risk Accepted | If management rejects a recommendation, or accepts an observation's identified risk. |
